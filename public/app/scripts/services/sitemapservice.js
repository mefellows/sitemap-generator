...
var placeholderServices = angular.module('sitemapSocketService', ['ngResource']);

placeholderServices.factory('SocketService', ['$q', '$rootScope', '$interval', function($q, $rootScope, $interval) {
